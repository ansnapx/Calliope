/*____________________________________________________________________________
	...
	$Id: pgpEME.h 47369 2006-08-31 23:32:55Z hal $
____________________________________________________________________________*/
...
PGPError 	PGPSDKM_PUBLIC_API PGPNewEMEContext( PGPSymmetricCipherContextRef ref,
...
PGPError 	PGPSDKM_PUBLIC_API PGPFreeEMEContext( PGPEMEContextRef ref );

/*____________________________________________________________________________
	Make an exact copy, including current state.  Original is not changed.
____________________________________________________________________________*/

PGPError 	PGPSDKM_PUBLIC_API PGPCopyEMEContext( PGPEMEContextRef ref, PGPEMEContextRef *outRef );

/*____________________________________________________________________________
	Key the EME context.  Key size is that of underlying symmetric cipher.
____________________________________________________________________________*/

PGPError 	PGPSDKM_PUBLIC_API PGPInitEME( PGPEMEContextRef ref, const void *key );
...
PGPError 	PGPSDKM_PUBLIC_API PGPEMEEncrypt( PGPEMEContextRef ref, const void *in,
					PGPSize bytesIn, void *out, PGPUInt64 offset,
					PGPUInt64 nonce );
					
PGPError 	PGPSDKM_PUBLIC_API PGPEMEDecrypt( PGPEMEContextRef ref, const void *in,
					PGPSize bytesIn, void *out, PGPUInt64 offset,
					PGPUInt64 nonce );
...
PGPError 	PGPSDKM_PUBLIC_API PGPEMEGetSizes( PGPEMEContextRef ref,
...
PGPError 	PGPSDKM_PUBLIC_API PGPEMEGetSymmetricCipher( PGPEMEContextRef ref,
