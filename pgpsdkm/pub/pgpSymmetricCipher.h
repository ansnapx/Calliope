/*____________________________________________________________________________
	...
	$Id: pgpSymmetricCipher.h 47014 2006-08-16 02:24:28Z ajivsov $
____________________________________________________________________________*/
...
PGPError 	PGPSDKM_PUBLIC_API PGPNewSymmetricCipherContext( PGPMemoryMgrRef memMgr,PGPCipherAlgorithm algorithm,PGPSymmetricCipherContextRef *outRef );
/*____________________________________________________________________________
...
PGPError 	PGPSDKM_PUBLIC_API PGPInitSymmetricCipher( PGPSymmetricCipherContextRef ref,const void *key );
...
PGPError 	PGPSDKM_PUBLIC_API PGPSymmetricCipherEncrypt( PGPSymmetricCipherContextRef ref,const void *in, void *out );
					
PGPError 	PGPSDKM_PUBLIC_API PGPSymmetricCipherDecrypt( PGPSymmetricCipherContextRef ref,const void *in, void *out );
/*____________________________________________________________________________
	Determine key and block size for specified algorithm.  Stateless routine
	does not need a context.
____________________________________________________________________________*/
PGPError 	PGPSDKM_PUBLIC_API PGPGetSymmetricCipherSizes( PGPSymmetricCipherContextRef ref,PGPSize *keySize, PGPSize *blockSize );
/*____________________________________________________________________________
...
____________________________________________________________________________*/
PGPError	PGPSymmetricCipherRollback( PGPSymmetricCipherContextRef ref,PGPSize size );
